...
export default function Home(){
 ...
 return <main className="app-shell playful-home">
  ...
  <style jsx global>{`
   ...
   .playful-home .playful-nav{padding-top:24px}.playful-brand{font-size:clamp(21px,4vw,30px);color:var(--play-ink)}
   ...
   .playful-hero{max-width:840px;padding:34px 0 72px}.beta-badge{display:inline-block;background:var(--play-yellow);padding:10px 18px;border-radius:999px;font-weight:900;transform:rotate(-1deg);box-shadow:0 4px 0 rgba(84,54,101,.08)}
   .playful-hero h1{font-size:clamp(36px,6vw,60px);line-height:1.16;letter-spacing:-.05em;margin:26px 0 20px;max-width:760px}.playful-hero h1 span{color:var(--play-pink)}
   .playful-hero>p{font-size:clamp(16px,2.4vw,22px);line-height:1.75;color:#5b4c72;max-width:760px}
   .experience-card-stack{display:grid;grid-template-columns:1fr 1.15fr 1fr;align-items:center;margin:48px 0 48px;max-width:820px}.experience-card{min-height:220px;background:#fff;border:4px solid var(--play-ink);border-radius:28px;display:grid;place-items:center;text-align:center;padding:24px;box-shadow:10px 13px 0 var(--play-ink);position:relative}.experience-card small{font-weight:900;color:#4b3590}.experience-card strong{font-size:clamp(19px,3vw,30px)}.experience-card span{font-size:46px}.experience-card-1{transform:rotate(-4deg) translateX(14px);z-index:1}.experience-card-2{background:var(--play-yellow);transform:translateY(-8px);z-index:3}.experience-card-3{transform:rotate(4deg) translateX(-14px);z-index:1}
   ...
   @media(max-width:720px){.playful-home{width:100%;border-radius:0;padding-left:22px;padding-right:22px}.playful-home .top-nav{align-items:flex-start}.playful-nav-links{flex-wrap:nowrap}.playful-hero{padding-top:28px}.experience-card-stack{margin-top:38px;grid-template-columns:1fr 1.12fr 1fr}.experience-card{min-height:170px;padding:14px 8px;border-width:3px;box-shadow:6px 9px 0 var(--play-ink)}.experience-card strong{font-size:18px;line-height:1.25}.experience-card span{font-size:34px}.experience-card-1{transform:rotate(-4deg) translateX(9px)}.experience-card-3{transform:rotate(4deg) translateX(-9px)}.playful-cta{border-radius:22px;padding:20px 22px}.playful-home .steps{grid-template-columns:1fr 1fr}.playful-note{font-size:15px!important}}
   @media(max-width:430px){.playful-hero h1{font-size:38px;line-height:1.18}.playful-hero>p{font-size:16px}.beta-badge{padding:9px 15px}.experience-card{min-height:150px}.experience-card small{font-size:11px}.experience-card strong{font-size:16px}.experience-card span{font-size:28px}.playful-nav-links a{padding:9px 13px}.playful-brand{font-size:20px}}
  `}</style>
 </main>
}
